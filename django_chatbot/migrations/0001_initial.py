    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('message', 'Message'), ('edited_message', 'Edited message'), ('channel_post', 'Channel post'), ('edited_channel_post', 'Edited channel post'), ('callback_query', 'Callback query')], default='message', max_length=20)),
                ('bot', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='django_chatbot.bot')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bot', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='django_chatbot.bot')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='django_chatbot.user')),
            ],
            options={
                'ordering': ['name'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('form', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='django_chatbot.form')),
            ],
        ),
        migrations.AddField(
            model_name='chat',
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(condition=models.Q(('user__isnull', True)), fields=('bot', 'name'), name='unique_periodic_task_name'),
        ),
